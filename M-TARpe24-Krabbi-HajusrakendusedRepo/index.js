...
const widgets = [
    { id: 11, name: "Cizzbor", price: 29.99 },
    { id: 12, name: "Woowo", price: 26.99 },
    { id: 13, name: "Crazlinger", price: 59.99 },
]
...
app.post('/widgets', (req, res) => {
    ...
    res.status(201).location('http://localhost:8080/widgets/' + (widgets.length)).send(
        newWidget
    )
})
